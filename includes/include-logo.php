...
//echo get_theme_mod('white_logo_upload');
	...
	//black logo condition (custom)
	
	if(basename( get_page_template() ) == 'blackpagetemp.php')
	{
		$logo_src 		=    get_theme_mod('white_logo_upload');
		$logo_sticky 		=    get_theme_mod('white_logo_upload');
		$logo_mobile 		=    get_theme_mod('white_logo_upload');
		$logo_mobile_sticky     =    get_theme_mod('white_logo_upload');
	}	
