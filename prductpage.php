...
// For display the data we need to echo it
        ...
        ?>
          <div class="image-box vc_col-sm-3 <?php echo $label; ?>"><a href="<?php echo get_permalink(); ?>" class="box-link"><img src="<?php echo get_the_post_thumbnail_url() ?>"></a><div class="below_title_gen"><?php echo get_the_title(); ?></div></div>
        <?php
      endwhile;
      wp_reset_postdata();
    ?>
